		...
		$sel_moda->execute();
		 ...
		 <div class="col-md-6 col-sm-12 col-lg-3">
		 	<div class="card" style="margin-top: 1%;">
		 		<img class="card-img-top" src="/ecommerce2/ecommerce_fase1/admin/<?php echo $f_moda['foto'] ?>" width="200" height="200">
		 		<div class="card-body">
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-12 col-lg-3" style="margin-top: 1%;">
			<div class="card" style="width: 100%;">
			  <img class="card-img-top" src="/ecommerce2/ecommerce_fase1/admin/<?php echo $f_elec['foto'] ?>" width="200" height="200" >
			  <div class="card-body">
...
<div class="container" style="margin-top: 3%;">
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-12 col-lg-3" style="margin-top: 1%;">
			<div class="card" style="width: 100%;">
			  <img class="card-img-top" src="/ecommerce2/ecommerce_fase1/admin/<?php echo $f_joy['foto'] ?>" width="200" height="200" >
			  <div class="card-body">
...
<div class="container" style="margin-top: 3%;">
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-12 col-lg-3" style="margin-top: 1%;">
			<div class="card" style="width: 100%;">
			  <img class="card-img-top" src="/ecommerce2/ecommerce_fase1/admin/<?php echo $f_rel['foto'] ?>" width="200" height="200" >
			  <div class="card-body">
...
<div class="container" style="margin-top: 3%;">
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-12 col-lg-3" style="margin-top: 1%;">
			<div class="card" style="width: 100%;">
			  <img class="card-img-top" src="/ecommerce2/ecommerce_fase1/admin/<?php echo $f_hogar['foto'] ?>" width="200" height="200" >
			  <div class="card-body">
...
<div class="container" style="margin-top: 3%;">
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-12 col-lg-3" style="margin-top: 1%;">
			<div class="card" style="width: 100%;">
			  <img class="card-img-top" src="/ecommerce2/ecommerce_fase1/admin/<?php echo $f_zapatos['foto'] ?>" width="200" height="200" >
			  <div class="card-body">
